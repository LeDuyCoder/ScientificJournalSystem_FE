...
const NAV_ITEMS = [
  { label: 'Ví của tôi', icon: 'lucide:wallet', path: ROUTES.WALLET },
  { label: 'Nạp Coin', icon: 'lucide:badge-plus', path: ROUTES.WALLET_TOP_UP },
  { label: 'Lịch sử giao dịch', icon: 'lucide:history', path: ROUTES.WALLET_TRANSACTIONS },
];
...
export default function WalletLayout({ children }) {
  ...
  return (
    <div className="wallet-layout-page">
      <Header />
