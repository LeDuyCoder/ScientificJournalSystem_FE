...
export default function PublicationTrendsChart({ data, years, selectedYear, onChangeYear }) {
  // Tìm giá trị lớn nhất trong data để tính tỉ lệ chiều cao cột (scale trục Y)
  const maxValue = Math.max(...data.map((d) => Math.max(d.manuscripts, d.published)), 1);
