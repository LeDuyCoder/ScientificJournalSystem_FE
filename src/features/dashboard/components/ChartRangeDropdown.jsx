...
export default function ChartRangeDropdown({ value, onChange }) {
  ...
  return (
    <div className="position-relative chart-range-wrapper" ref={wrapperRef}>
      {/* Trigger Button */}
      <button 
        className="btn chart-range-trigger d-flex align-items-center gap-2"
      ...
      {/* Popover */}
      {isOpen && (
        <div className="chart-range-popover">
          {/* Header */}
          <div className="crp-header">
            <span className="crp-title">Khoảng thời gian</span>
            <button 
              className="crp-reset"
              onClick={() => {
                onChange('5');
