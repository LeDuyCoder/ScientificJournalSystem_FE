    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          role: 'assistant',
          answer:
            'Xin lỗi, tôi chưa thể kết nối tới API chatbot. Vui lòng kiểm tra backend tại http://localhost:3000/api/v1/chat hoặc cấu hình VITE_RAG_CHAT_URL.',
          table: null,
          isError: true,
        },
      ]);
        ...
        <div className="rp-chatbot__panel" role="dialog" aria-label="AI Research Assistant">
          ...
          >
            <textarea
              ...
              placeholder="Nhập câu hỏi về bài báo, tạp chí, Q1/Q2..."
              rows="2"
            />
